...
public class JPlayer extends JComponent implements Animated, MouseListener, MouseMotionListener
{
    //---------------- instance variables ------------------------
...
////////////////////////////////////////////////////////////////
  ...
  Point newm = getParent().getMousePosition();
    int dx = newm.x - _saveMouse.x;
      int dy = newm.y - _saveMouse.y;
