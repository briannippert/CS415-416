...
/**
 * Reporter receives pre-defined report information at various points during
 * the Target game application. Depending on static settings, these reports may
 * be presented in a JOptionPane, or just recorded in a LOG file -- or other
 * options. This is essentially a collection of static methods tailored to the
 * app.
 * 
 * @author rdb 02/09/15
 */
...
public class Reporter
{
     ...
     *            char o, t, f, k
     * @param card
     *            String the 2-char representation of the base card
     */
