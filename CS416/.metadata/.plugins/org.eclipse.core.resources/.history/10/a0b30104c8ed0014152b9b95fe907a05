...
public class Q2_getParentTree
{
    ...
    public static class Tree
    {
        ...
        /**
         * Search for the node with the id value matching "key"
         *   in the subtree rooted at "root" and 
         *   return its parent. The parent of "root" is passed in as "parent". 
         */
        private Node getParent( Node node, String key, Node parent )
        {
           ...
           if(node == _root || node == null)
            ...
            {
             getParent(node.left,key,parent);
               getParent(node.right,key,parent);
            }
            else;
            return null;
        }
        ...
        private void add( Node cur, Node new1 )
        {
            ...
            if ( cmp < 0 )   // add to left subtree
                ...
                System.out.println( "Error: Tried to add another: " + new1.id );
        }
        //---------------------- toString() -----------------------------
        /**
    ...
    public static void main( String[] args )
    {
        ...
        System.out.println( "--------------- Q2_TreeAdd Tests---------------" );
        ...
        for ( int n = 0; n < nTrees; n++ )
        {
            ...
            System.out.println( "------ Parent of " + names[ n ] + ": " + parent 
                                   + " ------------" );
            //System.out.println( tree );
