...
public class Pellet extends JEllipse implements Animated
{
    ...
    public void setMove( double dx, double dy )
    {
        ...
        this.setLocation( ( p1.x + xIncr ), ( p1.y + yIncr ) );
     //   System.out.println( "xIncr: " + xIncr );
     //   System.out.println( "yIncr: " + yIncr );
     //   System.out.println( "p1.x: " + p1.x );
     //   System.out.println( "p1.y: " + p1.y );
        // System.out.println( "setMove Called" );
        // System.out.println("Pellet Location: " + this.getLocation());
    }
    ...
    public void setLocation( double xf, double yf )
    {
        ...
        //
        super.setLocation( (int) xf, (int) yf );
    ...
    public static void main( String[] args )
    {
        ...
        panel.add( p1 );
        System.out.println( "p1 " + p1.getCenter() );
        Pellet p2 = new Pellet( 0, 0, 10, 10 );
        panel.add( p2 );
        System.out.println( "p2 " + p2.getCenter() );
        Pellet p3 = new Pellet( 100, 100, 10, 10 );
        panel.add( p3 );
        System.out.println( "p3 " + p3.getCenter() );
        Pellet p4 = new Pellet( 250, 150, 10, 10 );
        panel.add( p4 );
        System.out.println( "p4 " + p4.getCenter() );
        // ////////////////////////////////////////////////////////////
