 ...
 * passes the command line args, the desired argument's index and a default
 * value for the argument if it is missing or not of the right type. There are
 * 3 methods: one for int arguments, one for float arguments and one for String
 * arguments. It is an error if the argument is present, but no exception is
 * thrown. An error message is printed to standard error and the default is
 * used. It is NOT an error if the argument is missing. Example calls: String
 * title = ReadArgs.getArg( args, 0, "" ); int nSteps = ReadArgs.getArg( args,
 * 1, 5 ); int stepSize = ReadArgs.getArg( args, 2, 1.0f );
 * 
 * @author rdb Extracted from earlier Utilities.java
 */
...
public class ReadArgs
{
     ...
     * 
     * @param args
     *            String[] command line argument array
     * @param which
     *            int index of desired
     * @param defaultVal
     *            int value returned if argument missing or incorrect
     * @return int
     */
     ...
     *            int index of desired
     * @param defaultVal
     *            float value returned if argument missing or incorrect
     * @return float
     */
     ...
     *            int index of desired
     * @param defaultVal
     *            String value returned if argument missing
     * @return String
     */
