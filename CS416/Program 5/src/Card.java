...
/**
 * Card -- models playing cards It has 2 public enums: one for the suit, one
 * for the rank
 * 
 * It has a framework for handling mouse events. It can keep track of the
 * CardGroup it belongs to.
 * 
 * @author mlb
 * 
 *         10/01/10 rdb modified to support either Ace HIGH or ACE low 02/17/13
 *         rdb removed unused reference to parent 02/22/14 rdb Replaced reading
 *         card images from a directory of files with reading the images from a
 *         jar file Simplified creation of filenames; removed it from student
 *         responsibility.
 */
...
public class Card extends JLabel implements Comparable<Card>, MouseListener
{
    ...
    // ---------------------- getAceHiFileName ------------------------
    /**
     * Get filename for the face image from the Rank when Ace is high. The file
     * names for clubs are: c1.gif == ace c2.gif == 2 ... c10.gif == 10 c11.gif
     * == jack c12.gif == queen c13.gif == king Other suits are the same except
     * the first letter is d or h or s.
     * 
     * @param s
     *            Suit the suit for the card
     * @param r
     *            Rank the rank for the card
     ...
     * @param cardName
     *            String the file name of desired image
     ...
     * 
     * @param up
     *            boolean if true set face of card facing up
     */
    ...
    // -------------------------- toString -------------------------
    /**
     * toString() -- a very short (2-character) string rep for the card. This
     * was inspired by code created by JB
     * 
    ...
    // --------------------- compareTo ------------------------------
    /**
     * compareTo uses the Rank as the major comparison, the Suit as a secondary
     * one.
     * 
     * @param o
     ...
     * 
     * @param o
     *            Card object to be compared to this
