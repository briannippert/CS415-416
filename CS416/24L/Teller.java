...
public class Teller extends Thread
{
    ...
    public void run()
    {
        ...
        while ( !shuttingDown || _clientsIn.size() > 0 )
        {
          synchronized(_clientsIn)
          {
           while(_clientsIn.size() == 0 && !shuttingDown)
           {
           System.out.println(_name + " About to Wait");
