...
public class Regex
{
  ...
  {  
    ...
    {
      _regexString = regex;
      _pattern =  Pattern.compile(_regexString,_flags);
      makeMatcher();
    }
    ///////////////////////////////////////////////////////////////
    // Step 1b.
  ...
  {  
    String results = "";
    if(_matcher == null)
      System.err.println("NULL Matcher");
    else 
    {
      if(_matcher.find() == true)
...
return results;
  ...
  public String findAll()
  {
        String results = "";
    if(_matcher == null)
      System.err.println("MATCHER Not Created");
    else
      while(_matcher.find() != false)
    {
  ...
  public String split()
  {
    ...
    if(_pattern != null && _inputString != null)
    {
     String[] temp = _pattern.split(_inputString); 
      for(String s:temp)
            {
        results += s + "\n";
      }
  ...
  {   String results = "";
    if(_matcher == null)
    {
     System.err.println("Matcher Not Defined"); 
    }
    else
      try{
