...
public class BinarySearchTree 
{
  ...
  private String inOrderString( Node n )
  {
    ...
    if(n.left == null)
      return n.data.toString() + " " + inOrderString(n.right);
    if(n.right == null)
      return inOrderString(n.left) + " " + n.data.toString();
    
    
    
    return inOrderString(n.left) + " " + n.data.toString() + " " + inOrderString(n.right);
  }
  //-------------------- height() ----------------------------------
  /**
  ...
  private Data find( Node n, String key )
  {
    ...
    if ( n == null )
      return null;
    int cmp = key.compareTo( n.data.key );
  ...
  private Data maxFind( Node n )
  {
    ...
    if(n.left != null)
    {
     Data maxLeft = maxFind(n.left);
     if(maxLeft.value > max.value)
       max = maxLeft;
    }
    
        if(n.right != null)
    {
     Data maxright = maxFind(n.right);
     if(maxright.value > max.value)
       max = maxright;
    }
