...
return false;
  ...
  int len = s.length();
   ...
   if(s.charAt(len-1) == s.charAt(len - 2))
        {
    return charPairTest(s.substring(0,len-2)); 
     ...
     // System.out.println( "*** exchangePairs *** not implemented" );
      ...
      else if(s.length() > 2)
      {
       ...
       if(temp2 == null){
        ...
        String temp4 = temp.substring(1,2);
         temp2 = temp3 + temp4 ; 
