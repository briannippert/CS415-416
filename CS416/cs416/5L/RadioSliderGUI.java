...
public class RadioSliderGUI extends JPanel
{
    ...
    private void buildSliders( Container parent )
    {
        ...
        // 3b. Invert ySlider
        //////////////////////////////////////////////////////////////
         ySlider = new JSlider( JSlider.VERTICAL, 0, 437, _initY );
        addLabels( ySlider, 100 );
        ySlider.setBorder( new LineBorder( Color.BLACK, 2 ) );
        ySlider.setInverted(true);
        
        SliderListener yListen = new SliderListener( ySlider, "y" );
        ySlider.addChangeListener( yListen );
        ...
        SliderListener szListen = new SliderListener( szSlider, "sz" );
        szSlider.addChangeListener( szListen );
    ...
    {        
        String[]  labels = { "Red", "Green", "Blue", "Magenta", "Yellow" };
