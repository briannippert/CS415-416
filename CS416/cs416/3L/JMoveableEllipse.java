/**
 * JMoveableEllipse.java: Draggable version of AEllipse
...
public class JMoveableEllipse extends JEllipse implements Animated
{
    //---------------- instance variables ------------------------
     ...
     */
    public JMoveableEllipse( Color aColor )
    { 
        this( 0, 0 );
        setColor( aColor );
    }
     ...
     */
    public JMoveableEllipse( int x, int y )
    {
        super( x, y );
        _draggable = true;
        _animated  = false;
    ...
    //---------------------- newFrame() --------------------------------
    /**
     * If JMoveableEllipse doesn't know its container, it doesn't know
