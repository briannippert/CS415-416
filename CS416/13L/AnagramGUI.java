...
public class AnagramGUI extends JFrame
{
    ...
    private ButtonGroup         _dsButtonGroup = null; // instance variable
                                           // so can deselect in size change
    //--------------------------- constructor -----------------------
     ...
     * as the first argument. The second argument is an ActionListener 
     * object that will handle all the buttons.
     */
    ...
    private JPanel makeRadioButtonMenu( String[] labels, ActionListener listen )
    {
        ...
        {
            if ( labels[i].charAt( 0 ) == '*' )  // button should be selected
            {  
