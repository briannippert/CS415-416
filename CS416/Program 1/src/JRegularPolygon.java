...
public class JRegularPolygon extends JAreaShape
{
    ...
    private void makePolygon( int locX, int locY )
    {
        ...
        _polygon = new Polygon( x, y, x.length );
    ...
    {
        Rectangle temploc = _polygon.getBounds();
        Point loc = temploc.getLocation();
    ...
    public void setSize( int aWidth, int aHeight )
    {
        ...
        {
            System.err.println( "HEIGHT AND WIDTH MUST BE THE SAME" );
        }
        // ////////////////////////////////////////////////////////
