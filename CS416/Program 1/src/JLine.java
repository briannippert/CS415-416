 ...
 * 02/06/09 rdb: Added getP1() and getP2()
 * 01/22/14 rdb: re-indented
 */
...
public class JLine extends JShape
{
    ...
    /**
     * Another wheels-like constructor; 2 endpoints.
     * @param x1 int
     * @param y1 int
     * @param x2 int
     * @param y2 int
    ...
    //------------------- getP1() ------------------------------
    /**
     * getP1() - a wheels-like method the first endpoint.
     * @return Point
     */
    public Point getP1()
    {
    ...
    //------------------- getP2() ------------------------------
    /**
     * getP2() - a wheels-like method the first endpoint.
     * @return Point
     */
    public Point getP2()
    {
