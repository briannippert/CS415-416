...
public class CardStack extends Stack<Card> implements CardGroup
{
    ...
    public CardStack( Container parent,  int x, int y )
    {
        ...
        ///////////////////////////////////////////////////////////////
        // 4b. Add a JLabel to mark the spot where the stack is located
        //     that becomes visible when the stack is empty.
        ///////////////////////////////////////////////////////////////
        JLabel j1 = new JLabel();
        j1.setSize(Card.width, Card.height);
        j1.setLocation(_xLoc,_yLoc);
        j1.setBorder(new LineBorder(Color.BLACK,1));
        j1.setText("Empty");
        j1.setOpaque(true);
    ...
    public void displayCards( int num, boolean face )
    {
        ...
        for ( int c = size( ) - 1; c >= 0; c-- )
        {
            ...
            //////////////////////////////////////////////////////////
            // 4a. Need to invoke setComponentZOrder method of our _parent
