...
/**
 * Represents the four row-column 2D array coordinates for the tiles of a
 * tetris shape.
 * 
...
public class Configuration extends Vector<Point>
{
    ...
    /**
     * Constructor. 8 integers representing the four row-column coordinates for
     * the four tiles of a tetris shape.
     * 
     * @param r1
     *            int
     * @param c1
     ...
     * 
     */
    public Configuration(int r1, int c1, int r2, int c2, int r3, int c3,
            int r4, int c4)
    {
    ...
    /******************************************************************/
    /**
     * getGraphicsCoordinates. Converts the local row, column coordinates of a
     * Shape to graphics x, y coordinates.
     * 
     * @param row
     *            int
     * @param col
    ...
    public Configuration getGraphicsCoordinates( int row, int col )
    {
        ...
        Configuration graphics = new Configuration( x, y, x2, y2, x3, y3, x4,
                y4 );
    ...
    public Configuration getBoardCoordinates( int r, int c )
    {
        ...
        Configuration board = new Configuration( r + this.get( 0 ).x, c
                + this.get( 0 ).y, r + this.get( 1 ).x, c + this.get( 1 ).y, r
                + this.get( 2 ).x, c + this.get( 2 ).y, r + this.get( 3 ).x, c
                + this.get( 3 ).y );
